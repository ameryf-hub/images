...
**Source release/branch:** [v0.4.29](https://github.com/devcontainers/images/tree/v0.4.29/src/dotnet)
...
**Digest:** sha256:d3dcec664732990963f3ea6d64bcdb17f260c26740ac1859947b79c184850a39

**Tags:**
```
mcr.microsoft.com/devcontainers/dotnet:2.1.3-11.0-preview-resolute
mcr.microsoft.com/devcontainers/dotnet:2.1.3-11.0-preview
mcr.microsoft.com/devcontainers/dotnet:2.1.3-11.0-preview-resolute
```
...
|--------------------|---------|------|
| [.NET](https://dotnet.microsoft.com/) | 11.0.1005.26302.115 () | /usr |
...
**Digest:** sha256:be5bd898d964c0d081cb22285c2318e488882103702c8831418fdd59218fd5dd

**Tags:**
```
mcr.microsoft.com/devcontainers/dotnet:2.1.3-10.0-noble
mcr.microsoft.com/devcontainers/dotnet:2.1.3-10.0
mcr.microsoft.com/devcontainers/dotnet:2.1.3-10.0-noble
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
| Language / runtime | Version | Path |
|--------------------|---------|------|
| [.NET](https://dotnet.microsoft.com/) | 10.0.301 () | /usr |
...
**Digest:** sha256:9e456b59071bcf9fcd59fc4dea2054f49e71a6ffaf12218f4753d6aa21d7c95d

**Tags:**
```
mcr.microsoft.com/devcontainers/dotnet:2.1.3-9.0-bookworm-slim
mcr.microsoft.com/devcontainers/dotnet:2.1.3-9.0
mcr.microsoft.com/devcontainers/dotnet:2.1.3-9.0-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
| Language / runtime | Version | Path |
|--------------------|---------|------|
| [.NET](https://dotnet.microsoft.com/) | 9.0.315 (9.0.1) | /usr |
...
**Digest:** sha256:a322dd17f944c87cc841f4b440fd1665d3a7228811ea07ed17d7ca6d760497bb

**Tags:**
```
mcr.microsoft.com/devcontainers/dotnet:2.1.3-9.0-noble
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:822661e04f30b7e39271c40ce6bf9d166eb9d301e925b9748938685648bfc8e3

**Tags:**
```
mcr.microsoft.com/devcontainers/dotnet:2.1.3-8.0-bookworm-slim
mcr.microsoft.com/devcontainers/dotnet:2.1.3-8.0
mcr.microsoft.com/devcontainers/dotnet:2.1.3-8.0-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
| Language / runtime | Version | Path |
|--------------------|---------|------|
| [.NET](https://dotnet.microsoft.com/) | 8.0.422 (8.0.2) | /usr |
...
**Digest:** sha256:9ae8a14ead163999d40946ecb832f1814336684f0053bb141ffb6dbd84488b0e

**Tags:**
```
mcr.microsoft.com/devcontainers/dotnet:2.1.3-8.0-noble
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:d71a97af2315731226cb6bc788151c386d22a6424c331306ad15ccc7f142387c

**Tags:**
```
mcr.microsoft.com/devcontainers/dotnet:2.1.3-8.0-jammy
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
