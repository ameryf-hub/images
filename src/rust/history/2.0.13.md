...
**Image version:** 2.0.13

**Source release/branch:** [v0.4.29](https://github.com/devcontainers/images/tree/v0.4.29/src/rust)
...
**Digest:** sha256:1707e2a8007968925f110c0961811200e9bb10e0ec055e2734857c59189a8b13

**Tags:**
```
mcr.microsoft.com/devcontainers/rust:2.0.13-trixie
mcr.microsoft.com/devcontainers/rust:2.0.13-1
mcr.microsoft.com/devcontainers/rust:2.0.13-1-trixie
```
...
|--------------------|---------|------|
| [Rust](https://github.com/rust-lang/rust) | 1.96.1 | /usr/local/cargo<br />/usr/local/rustup |
...
**Digest:** sha256:4b356e56d256b8e835c7e08b2aef302cc92b7c459e5705ac36a6e6d090955f00

**Tags:**
```
mcr.microsoft.com/devcontainers/rust:2.0.13-bookworm
mcr.microsoft.com/devcontainers/rust:2.0.13-1-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:245ee7061d05051996dc24a869ed3e309142b1089feb342e410fb0ac42957dad

**Tags:**
```
mcr.microsoft.com/devcontainers/rust:2.0.13-bullseye
mcr.microsoft.com/devcontainers/rust:2.0.13-1-bullseye
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
